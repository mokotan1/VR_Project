...
namespace OsFPS
{
    ...
    public class RigidbodyMotor : EntityMotor
    {
        ...
        public override void OnRegisterEventHandlers()
        {
            ...
            this.entity.model.motorVelocity.SetGetter(() => this.rigidbody.linearVelocity);
        }
        ...
        public override void FixedUpdate()
        {
            ...
            // if (grounded)
            {
                ...
                {
                    rigidbody.linearVelocity = new Vector3(velocity.x, CalculateJumpVerticalSpeed(), velocity.z) * (grounded ? 1 : this.inAirControl);
                }
