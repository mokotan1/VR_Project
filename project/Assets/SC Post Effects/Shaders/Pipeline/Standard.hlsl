...
#define SCREEN_COLOR(uv) SAMPLE_TEXTURE2D(_MainTex, sampler_LinearClamp, uv);
...
float4 ScreenColorTiled(float2 uv) {
	return SAMPLE_TEXTURE2D(_MainTex, sampler_LinearRepeat, uv);
}
