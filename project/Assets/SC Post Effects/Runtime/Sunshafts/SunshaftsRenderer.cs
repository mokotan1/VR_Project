...
namespace SCPE
{
    public class SunshaftsRenderer : ScriptableRendererFeature
    {
        class SunshaftsRenderPass : PostEffectRenderer<Sunshafts>
        {
            ...
            protected override void OnSCPECameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                base.OnSCPECameraSetup(cmd, ref renderingData);
            ...
            protected override void ExecuteSCPE(ScriptableRenderContext context, ref RenderingData renderingData)
            {
